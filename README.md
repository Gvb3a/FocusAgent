...
- [ ] Построение графиков продуктивности/тренировок
- [ ] Добавить других провайдеров 
- [ ] Начальное создание профиля (цели, упражнения и т.д.)
- [ ] Протестировать на Windows и Linux
